...
public final class MultiplexBlockDevice implements BlockDevice {
    ...
    /** @see de.org.mchahn.baselib.io.BlockDevice#blockSize() */
    public int blockSize() {
        return this.bdev.blockSize();
    }

    /** @see de.org.mchahn.baselib.io.BlockDevice#readOnly() */
    public boolean readOnly() {
        return this.bdev.readOnly();
    }

    /** @see de.org.mchahn.baselib.io.BlockDevice#serialWrite() */
    public boolean serialWrite() {
        return this.bdev.serialWrite();
    }

    /** @see de.org.mchahn.baselib.io.BlockDevice#size() */
    public long size() {
        return this.bdev.size();
    }

    /** @see de.org.mchahn.baselib.io.BlockDevice#writeOnly() */
    ...
    /** @see de.org.mchahn.baselib.io.BlockDevice#write(long, byte[], int) */
    ...
    /** @see de.org.mchahn.baselib.io.BlockDevice#close(boolean) close() */
    ...
    /** @see de.org.mchahn.baselib.io.BlockDevice#read(long, byte[], int) */
