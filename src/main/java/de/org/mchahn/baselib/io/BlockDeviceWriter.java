 ...
 */
public abstract class BlockDeviceWriter {
    public static final int ERROR_UNKNOWN = -1;
    public static final int ERROR_NOERROR = 0;
    public static final int ERROR_TOO_MUCH_DATA = 1;
    public static final int ERROR_FILE_SIZE_CHANGED_LO = 2;
    public static final int ERROR_FILE_SIZE_CHANGED_HI = 3;
    public static final int ERROR_DIRECTORY_TOO_LARGE = 4;
    public static final int ERROR_FILE_TOO_LARGE = 5;
    public static final int ERROR_NAME_TOO_LONG = 6;
    public static final int ERROR_PATH_TOO_LONG = 7;

    /** custom error codes start at this base...*/
    public static final int ERROR_CUSTOM_BASE = 1000;
    ...
    public static Progress newDebugProgress(final PrintStream out) {
        return (dir, node) -> {
            ...
            while (null != dir);
            out.printf("DEBUG.onFile - path='%s' name='%s' size=%d)%n",
     ...
     */
    protected BlockDeviceWriter(FileRegistrar freg, Properties props) {
        this.props = props;
        this.freg  = freg;
    }
